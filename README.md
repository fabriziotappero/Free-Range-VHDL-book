...
If you want to download the PDF version of this book, grab the 
[last version](https://github.com/fabriziotappero/Free-Range-VHDL-book/releases) 
and compile it. Here you can find the [PDF](https://github.com/fabriziotappero/Free-Range-VHDL-book/tree/master/free_range_vhdl.pdf). To buy the paperback version you can head to
