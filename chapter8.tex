...
\noindent
\textbf{EXAMPLE 22.}
Design a 3-bit comparator using a VHDL structural modelling. The interface to this circuit is described in the diagram below.
\end{minipage}
