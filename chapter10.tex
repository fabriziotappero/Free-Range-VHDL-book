...
The use of \texttt{signed/unsigned} types is desirable any time your begs of bits (signals, variables or constants) stop being ``begs'' and become numbers of type signed, unsigned or even integers.
