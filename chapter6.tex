...
\hline
\multirow{2}{*}{adding} & \texttt{+} & addition & \\
& \texttt{-} & subtraction &  \\
\hline
...
\hline
\multirow{3}{*}{other} & \texttt{**} & exponentiation & often limited to powers of two\\
