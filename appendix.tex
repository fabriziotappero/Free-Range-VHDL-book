...
\noindent
{\scriptsize
\url{https://github.com/fabriziotappero/Free-Range-VHDL-book/tree/master/pics/ref_cards}
}

\newpage\clearpage
\thispagestyle{empty}
\includepdf[pages=-,angle=90]{pics/ref_cards/vhdlqrc.pdf}
\includepdf[pages=-,angle=90]{pics/ref_cards/1164qrc.pdf}
\thispagestyle{empty}
\null\newpage
